...
<%@ page import="dao.Dao, dao.CategoriaDao, classes.Categoria, java.util.*"%>
    ...
    <body>
            ...
            <div class="content">        
             <%
                ...
                List<Categoria> list = CategoriaDao.getRelatorio();
                request.setAttribute("list", list);
               
               int[] valores = CategoriaDao.getRelatorioCategoria();
